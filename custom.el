(custom-set-variables
 ...
 '(jabber-account-list (quote (("maglo@chat.facebook.com" (:network-server . "chat.facebook.com") (:port . 5222) (:connection-type . network)) ("magnus.loof@basalt.se" (:network-server . "talk.google.com") (:port . 5223) (:connection-type . ssl)))))
