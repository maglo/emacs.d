(custom-set-variables
 ...
 '(jabber-account-list (quote (("magnus.loof@gmail.com" (:network-server . "talk.google.com") (:port . 5223) (:connection-type . ssl)) ("maglo@chat.facebook.com" (:disabled . t) (:network-server . "chat.facebook.com") (:port . 5222) (:connection-type . network)) ("magnus.loof@basalt.se" (:network-server . "talk.google.com") (:port . 5223) (:connection-type . ssl)))))
 '(jabber-default-show "")
